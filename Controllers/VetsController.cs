...
namespace NH645015_MIS4200.Controllers
{
    public class VetsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "vetID,firstName,lastName,Phone")] Vet vet)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "vetID,firstName,lastName,Phone")] Vet vet)
        {
            if (ModelState.IsValid)
            {
